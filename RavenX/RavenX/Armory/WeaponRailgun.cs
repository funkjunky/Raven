...
namespace Mindcrafters.RavenX.Armory
{
    ...
    public sealed class WeaponRailgun : Weapon
    {
        ...
        public override void ShootAt(Vector2 pos)
        {
            ...
            //fire a round
            GameManager.GameManager.Instance.AddRailgunSlug(Owner, pos);
            ...
            GameManager.GameManager.Instance.Map.AddSoundTrigger(
                Owner,
                GameManager.GameManager.Instance.Parameters.RailgunSoundRange);
        }
        ...
        protected override void InitializeFuzzyModule()
        {
            ...
            FzSet ammoLoads =
                ammoStatus.AddRightShoulderSet("ammoLoads", 15, 30, 100);
            FzSet ammoOkay = ammoStatus.AddTriangularSet("ammoOkay", 0, 15, 30);
            FzSet ammoLow = ammoStatus.AddTriangularSet("ammoLow", 0, 0, 15);
