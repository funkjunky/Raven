...
namespace Mindcrafters.Tx2D.GameAI
{
    ...
    public class GameManager
    {
        ...
        ///</summary>
        public GameManager()
            : this(@"data\maps\RavenMapWithDoors")
        {
        }
        ...
        public void TagBotsWithinViewRange(Entity bot, float range)
        {
            Entity.TagNeighbors(bot, _botList, range);
        }
        ...
        public Vector2 GetPosOfClosestSwitch(Vector2 botPos, uint doorId)
        {
            ...
            {
                Entity trig = EntityManager.Instance.GetEntityFromId(switchId);
        ...
        //MinimapComponent CreateMinimapComponent(
        ...
        Map _map;
        readonly List<BotEntity> _botList;
        BotEntity _selectedBot;
