...
namespace Mindcrafters.RavenX.Goal.Composite
{
    ...
    public class Think : CompositeGoal
    {
        ...
        ///Add composite goal <see cref="Explore"/>
        ///</summary>
        public void AddGoalCaptureFlag()
        {
            if (!NotPresent(GoalTypes.CaptureFlag))
                return;
            LogUtil.WriteLineIfLogThink(LogPrefixText + LogAddGoalText +
                                        LogStatusText +
                                        " CaptureFlag");
            ...
            RemoveAllSubgoals();
            AddSubgoal(new CaptureFlag(Bot));
        }
        ///<summary>
        ...
        {
            if (!NotPresent(GoalTypes.AttackTarget) || !NotPresent(GoalTypes.SeekToPosition))
                return;
        ...
        //    //(EvaluatorFollowFormation)this._evaluators.Find(delegate(Evaluator.Evaluator ev) { return ev.GetType().Equals(typeof(EvaluatorFollowFormation)); });

        //    RemoveAllSubgoals();
        //    AddSubgoal(new FollowFormation(Bot, groupFormation));
        //}

        //public void AddGoalLeadFormation()
        //{
        //    if (!NotPresent(GoalTypes.LeadFormation))
        //        return;
        //
        //    LogUtil.WriteLineIfLogThink(LogPrefixText + LogAddGoalText +
        //                                LogStatusText +
        ...
        //
        //    RemoveAllSubgoals();
        //    AddSubgoal(new LeadFormation(Bot, Bot.CurrentFormation));
        //}
