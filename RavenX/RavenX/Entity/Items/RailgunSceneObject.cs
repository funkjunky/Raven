...
{
    ///<summary>
    ///class for RailgunSceneObject
    ///</summary>
    internal class RailgunSceneObject : T2DStaticSprite, IEntitySceneObject
    {
        ...
        public void Initialize(Entity entity)
        {
            ...
            //Material =
            //   TorqueObjectDatabase.Instance.FindObject("railgunMaterial")
            //   as SimpleMaterial;

            SimpleMaterial simpleMaterial = new SimpleMaterial();
            simpleMaterial.TextureFilename =
                @"data\images\Mindcrafters\railgun";
