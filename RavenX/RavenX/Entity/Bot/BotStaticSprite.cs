...
{
    ///<summary>
    ///BotStaticSprite is a specialized T2DStaticSprite with an associated 
    ///<see cref="BotEntity"/>
    ///</summary>
    public class BotStaticSprite : T2DStaticSprite, IBotSceneObject
    {
        ...
        ///</summary>
        public BotStaticSprite(GameManager.GameManager.Teams team)
            : this(team, null)
        {
        }
        ...
        public void Initialize(Entity entity)
        {
            ...
            switch (_team)
            {
                case GameManager.GameManager.Teams.Blue:
                    Material =
                        TorqueObjectDatabase.Instance.FindObject<SimpleMaterial>(
                            "HoverTankBlueMaterial");
                    break;
                case GameManager.GameManager.Teams.Red:
                    Material =
                        TorqueObjectDatabase.Instance.FindObject<SimpleMaterial>(
                            "HoverTankRedMaterial");
                    break;
                case GameManager.GameManager.Teams.Green:
                    Material =
                        TorqueObjectDatabase.Instance.FindObject<SimpleMaterial>(
                            "HoverTankGreenMaterial");
                    break;
                case GameManager.GameManager.Teams.Yellow:
                    Material =
                        TorqueObjectDatabase.Instance.FindObject<SimpleMaterial>(
                            "HoverTankYellowMaterial");
                    break;
            }
