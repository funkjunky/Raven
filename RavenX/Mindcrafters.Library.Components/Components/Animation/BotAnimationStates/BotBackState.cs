...
{
    #region Class BotBackState

    ///<summary>
    ///class for BotBackState (bot moving backwards)
    ///</summary>
    public class BotBackState : FSMState
    {
        //======================================================================
        ...
        public override string Execute(IFSMObject obj)
        {
            ...
            Assert.Fatal(null != bot,
                "BotBackState.Execute: bot is null");
            ...
            if (bot.Physics.Velocity.Length() > 0.1f)
            {
                if (projection.Length() > normal.Length())
                {
                    ...
                    //bot.SetSequence("main", "back", 0); //already set
