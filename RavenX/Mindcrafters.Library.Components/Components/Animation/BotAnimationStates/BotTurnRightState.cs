...
{
    #region Class BotTurnRightState

    ///<summary>
    ///class for BotTurnRightState (bot turning right)
    ///</summary>
    public class BotTurnRightState : FSMState
    {
        //======================================================================
        ...
        public override string Execute(IFSMObject obj)
        {
            ...
            Assert.Fatal(null != bot,
                "BotTurnRightState.Execute: bot is null");
            ...
            {
                //bot.SetSequence("main", "side", 0); //already set
