...
{
    ///<summary>
    ///A tank movement component
    ///</summary>
    [TorqueXmlSchemaType]
    [TorqueXmlSchemaDependency(Type = typeof(T2DPhysicsComponent))]
    public class TankMovementComponent : MovementComponent
    {
        //======================================================================
        ...
        //{
        //    base.CopyTo(obj);
        //    //TankMovementComponent obj2 = obj as TankMovementComponent;
        //    //if (obj2 == null)
        //    //    return;
