...
{
    ///<summary>
    ///Content Pipeline class for loading SpawnPoint data from XNB format.
    ///</summary>
    public class SpawnPointReader : ContentTypeReader<SpawnPointData>
    {
        ///<summary>
        ...
        protected override SpawnPointData Read(
            ContentReader input, SpawnPointData existingInstance)
        {
